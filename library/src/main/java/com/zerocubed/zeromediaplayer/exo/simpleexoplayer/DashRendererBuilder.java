 ...
 */
package com.zerocubed.zeromediaplayer.exo.simpleexoplayer;
...
/**
 * A {@link SimpleExoPlayer.RendererBuilder} for DASH.
 */
public class DashRendererBuilder implements SimpleExoPlayer.RendererBuilder {
    ...
    @Override
    public void buildRenderers(SimpleExoPlayer player) {
    ...
    private static final class AsyncRendererBuilder
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url,
                                    MediaDrmCallback drmCallback, SimpleExoPlayer player) {
            this.context = context;
            this.userAgent = userAgent;
            this.drmCallback = drmCallback;
            this.player = player;
        ...
        public void onSingleManifest(MediaPresentationDescription manifest) {
            ...
            if (manifest.dynamic && manifest.utcTiming != null) {
                UtcTimingElementResolver.resolveTimingElement(manifestDataSource, manifest
                                .utcTiming,
        ...
        private void buildRenderers() {
            ...
            if (hasContentProtection) {
                if (Util.SDK_INT < 18) {
                    player.onRenderersError(
                            new UnsupportedDrmException(UnsupportedDrmException
                ...
                try {
                    drmSessionManager = StreamingDrmSessionManager.newWidevineInstance(
                            player.getPlaybackLooper(), drmCallback, null, player.getMainHandler
                                    (), player);
                    filterHdContent = getWidevineSecurityLevel(drmSessionManager) !=
                            SECURITY_LEVEL_1;
            ...
            ChunkSource videoChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    elapsedRealtimeOffset, mainHandler, player, SimpleExoPlayer.TYPE_VIDEO);
            ChunkSampleSource videoSampleSource = new ChunkSampleSource(videoChunkSource,
                    loadControl,
                    VIDEO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    SimpleExoPlayer.TYPE_VIDEO);
            ...
            ChunkSource audioChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    elapsedRealtimeOffset, mainHandler, player, SimpleExoPlayer.TYPE_AUDIO);
            ChunkSampleSource audioSampleSource = new ChunkSampleSource(audioChunkSource,
                    loadControl,
                    AUDIO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    SimpleExoPlayer.TYPE_AUDIO);
            ...
            ChunkSource textChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    LIVE_EDGE_LATENCY_MS,
                    elapsedRealtimeOffset, mainHandler, player, SimpleExoPlayer.TYPE_TEXT);
            ChunkSampleSource textSampleSource = new ChunkSampleSource(textChunkSource, loadControl,
                    TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    SimpleExoPlayer.TYPE_TEXT);
            TrackRenderer textRenderer = new TextTrackRenderer(textSampleSource, player,
                    mainHandler.getLooper());

            // Invoke the callback.
            TrackRenderer[] renderers = new TrackRenderer[SimpleExoPlayer.RENDERER_COUNT];
            renderers[SimpleExoPlayer.TYPE_VIDEO] = videoRenderer;
            renderers[SimpleExoPlayer.TYPE_AUDIO] = audioRenderer;
            renderers[SimpleExoPlayer.TYPE_TEXT] = textRenderer;
