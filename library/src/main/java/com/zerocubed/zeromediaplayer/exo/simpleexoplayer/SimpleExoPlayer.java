 ...
 */
public class SimpleExoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         * {@link SimpleExoPlayer#onRenderers}
         *               should be invoked once the renderers have been built. If building fails,
         *               {@link SimpleExoPlayer#onRenderersError} should be invoked.
         */
        void buildRenderers(SimpleExoPlayer player);

        /**
         * Cancels the current build operation, if there is one. Else does nothing.
         * <p>
         * A canceled build operation must not invoke {@link SimpleExoPlayer#onRenderers} or
         * {@link SimpleExoPlayer#onRenderersError} on the player, which may have been released.
         */
        void cancel();
    }
     ...
     *
     * @param renderers      Renderers indexed by {@link SimpleExoPlayer} TYPE_* constants. An
     *                       individual
  ...
  /* package */ void onRenderersError(Exception e) {
    ...
    @Override
    public void onAudioTrackUnderrun(int bufferSize, long bufferSizeMs, long
