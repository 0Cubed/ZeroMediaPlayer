...
/**
 * A {@link SimpleExoPlayer.RendererBuilder} for HLS.
 */
public class HlsRendererBuilder implements SimpleExoPlayer.RendererBuilder {
    ...
    private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url,
            ...
            playlistFetcher = new ManifestFetcher<>(url, new DefaultUriDataSource(context,
                    userAgent),
                    parser);
        }
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            PtsTimestampAdjusterProvider timestampAdjusterProvider = new
            ...
            MediaCodecVideoTrackRenderer videoRenderer = new MediaCodecVideoTrackRenderer(context,
                    sampleSource, MediaCodecSelector.DEFAULT, MediaCodec
            ...
            if (haveAudios) {
                ...
                audioRenderer = new MediaCodecAudioTrackRenderer(
                        new SampleSource[]{sampleSource, audioSampleSource}, MediaCodecSelector
                        .DEFAULT, null,
                        true, player.getMainHandler(), player, AudioCapabilities.getCapabilities
                        (context),
            ...
            if (haveSubtitles) {
                ...
                HlsSampleSource textSampleSource = new HlsSampleSource(textChunkSource, loadControl,
                        TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, SimpleExoPlayer.TYPE_TEXT);
            ...
            renderers[SimpleExoPlayer.TYPE_METADATA] = id3Renderer;
