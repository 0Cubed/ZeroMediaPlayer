package com.zerocubed.zeromediaplayer.demo;
...
public class PlayerActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSurfaceView = (SurfaceView) findViewById(R.id.svPlayer);
        ...
        mAspectRatioFrameLayoutPlayer.setResizeMode(AspectRatioFrameLayout.RESIZE_MODE_FIT);
    }
